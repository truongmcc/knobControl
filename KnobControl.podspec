...
s.homepage     = "http://raywenderlich.com"
  ...
  s.author             = { "picshertho" => "picshertho@voila.fr" }
  # Or just: s.author    = "picshertho"
  # s.authors            = { "picshertho" => "picshertho@voila.fr" }
  # s.social_media_url   = "http://twitter.com/picshertho"
  ...
  s.source       = { :git => "https://github.com/truongmcc/knobControl.git", :tag => "1.0.0" }
